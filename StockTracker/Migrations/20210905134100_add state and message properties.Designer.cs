...
namespace StockTracker.Migrations
{
    ...
    [Migration("20210905134100_add state and message properties")]
    partial class addstateandmessageproperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockTracker.Model.DeviceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StockTracker.Model.Device", b =>
                {
                    b.HasOne("StockTracker.Model.DeviceType", "DeviceType")
                        .WithMany("Devices")
